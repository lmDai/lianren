...
public class CircleMovementMethod extends BaseMovementMethod {
    ...
    private final static int DEFAULT_CLICKABLEA_COLOR_ID = R.color.day_colorPrimary;
    /**整个textView的背景色*/
    ...
    public CircleMovementMethod(){
        this.textViewBgColor = LRApplication.context().getResources().getColor(DEFAULT_COLOR_ID);
        this.clickableSpanBgClor = LRApplication.context().getResources().getColor(DEFAULT_CLICKABLEA_COLOR_ID);
    }
