...
public class PageNumberListPoint extends LinearLayout {
    ...
    public PageNumberListPoint(Context context) {
        super(context);
        this.context = context;
        initView();
    }

    public PageNumberListPoint(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
        initView();
    }

    public PageNumberListPoint(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    public void addDot(List<String> pager) {
        ...
        for (int i = 0; i < countPoint; i++) {
            ...
            params.setMargins(0, 0, 10, 0); //设置外边距
            imageView.setLayoutParams(params);
            imageView.setImageResource(R.mipmap.ic_dot_print);
