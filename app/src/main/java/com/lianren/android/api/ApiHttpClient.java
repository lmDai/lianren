...
public class ApiHttpClient {
    ...
    public static String API_URL = BuildConfig.API_URL;//测试
//    public static String API_URL = "http://api.lianren123.cn/%s";//正式
    ...
    public static void post(String partUrl, JSONObject jsonObject, AsyncHttpResponseHandler handler) {
        ...
        log("POST " + partUrl + "?" + jsonObject.toString());
        CLIENT.post(LRApplication.context(), getAbsoluteApiUrl(partUrl), entity, "application/json", handler);
    }
    ...
    public static void setHttpClient(AsyncHttpClient c) {
        ...
        if (!TextUtils.isEmpty(LRSharedPreference.getInstance().getToken()))
            c.addHeader("Authorization", "Bearer " + LRSharedPreference.getInstance().getToken());
        CLIENT = c;
        initSSL(CLIENT);
        initSSL(API.mClient);
    }
    ...
    public static void setCookieHeader(String cookie) {
        ...
        if (!TextUtils.isEmpty(cookie))
            CLIENT.addHeader("Authorization", "Bearer " + cookie);
