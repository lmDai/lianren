...
import com.lianren.android.improve.explore.adapter.ShopGoodAdapter;
import com.lianren.android.improve.explore.presenter.ShopGoodsContract;
import com.lianren.android.improve.explore.presenter.ShopGoodsPresenter;
import com.lianren.android.ui.dialog.InviteTimeDialog;
 ...
 * @description:邀约选择
 **/
public class ShopGoodsActivity extends BackActivity implements ShopGoodsContract.View {
    ...
    private ShopGoodsContract.Presenter mPresenter;
    private int shop_id;
    private int source;
    private ShopGoodAdapter mAdapter;
    private UsersInfoBean.BaseBean mReceiver;
    private String time;
    private ShopGoodsBean detailBean;
    ...
    protected void initData() {
        ...
        mPresenter = new ShopGoodsPresenter(this);
        mPresenter.getShopGoods(shop_id, source);
        ImageLoader.loadImage(getImageLoader(), imgAvater, mReceiver.avatar_url);
        tvNickname.setText(mReceiver.nickname);
    }

    @Override
    public void showShopGood(ShopGoodsBean detailBean) {
    ...
    @Override
    public void setPresenter(ShopGoodsContract.Presenter presenter) {
    ...
    private void createOrder() {
        ...
        showLoadingDialog();
        mPresenter.datingCreate(mReceiver.id, 2, shop_id, mAdapter.getChecked().id, time);
    }
...
//               initTimePicker();
    ...
    private void initInviteDate() {
        ...
        new InviteTimeDialog.Builder(this).
                setTimeLimit(detailBean.s_time, detailBean.e_time).setListener(new InviteTimeDialog.OnListener() {
            @Override
            public void onSelected(Dialog dialog, Date date) {
                time = DateUtil.dateTostr(date, "yyyy-MM-dd HH:mm");
                tvSelectTime.setText("邀约 " + DateUtil.dateTostr(date, "yyyy-MM-dd HH:mm"));
            }
