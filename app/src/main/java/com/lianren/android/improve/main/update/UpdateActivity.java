...
public class UpdateActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void initData() {
        ...
        mTextUpdateInfo.setText(Html.fromHtml(mVersion.intro));
        btnNotShow.setVisibility(mVersion.update_type == 1 ? View.VISIBLE : View.GONE);
    }

    @OnClick({R.id.btn_update, R.id.btn_not_show})
    @Override
        ...
        if (requestCode == RC_EXTERNAL_STORAGE) {
            if (grantResults.length > 0
                ...
                DialogHelper.getConfirmDialog(this, "温馨提示",
                        "需要开启" + getString(R.string.app_name) + "对您手机的存储权限才能下载安装，是否现在开启",
                        "去开启", "取消",
