...
public class ContactUserAdapter extends BaseRecyclerAdapter<ContactUserBean> {

    private OnViewClickListener mDeleteListener;
    private OnViewClickListener mShiledListener;
    ...
    protected RecyclerView.ViewHolder onCreateDefaultViewHolder(ViewGroup parent, int type) {
        return new TagHolder(mInflater.inflate(R.layout.adapter_contact_user, parent, false));
    }
    ...
    protected void onBindClickListener(RecyclerView.ViewHolder holder) {
        ...
        h.tvShield.setTag(holder);
        h.tvShield.setOnClickListener(mShiledListener);
        h.llItem.setTag(holder);
        h.llItem.setOnClickListener(itemListener);
    }

    public void setmShiledListener(OnViewClickListener mShiledListener) {
        this.mShiledListener = mShiledListener;
    }
    ...
    private static final class TagHolder extends RecyclerView.ViewHolder {
        ...
        private TextView tvNickName, mTextDelete,tvShield;
        ...
        private TagHolder(View itemView) {
            ...
            tvShield = itemView.findViewById(R.id.shield);
