...
public class MessageListPresenter implements MessageListContract.Presenter {
    ...
    private final MessageListContract.EmptyView mEmptyView;

    public MessageListPresenter(MessageListContract.View mView, MessageListContract.EmptyView mEmptyView) {
        this.mView = mView;
    ...
    public void getSystemMessage(int page) {
        LRApi.systemMessageList(page, new CommonHttpResponseHandler() {
            @Override
            ...
            public void onSuccess(int statusCode, Header[] headers, String responseString) {
                try {
                    Type type = new TypeToken<ResultPageBean<SystemMessageBean>>() {
                    }.getType();

                    ResultPageBean<SystemMessageBean> resultBean = AppOperator.createGson().fromJson(responseString, type);
