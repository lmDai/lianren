package com.lianren.android.improve.behavior;
...
public class KeyboardActionDelegation {
    ...
    public void onEmotionItemSelected(Emojicon emotion) {
        ...
        if (start == end) {
            mInput.append(InputHelper.displayEmoji(mContext.getResources(), emotion.getEmojiStr()));
        } else {
            Spannable str = InputHelper.displayEmoji(mContext.getResources(), emotion.getEmojiStr());
