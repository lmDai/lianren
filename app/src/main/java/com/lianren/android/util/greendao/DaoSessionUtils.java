...
public class DaoSessionUtils {
    ...
    public static DaoSession getDaoInstance() {
        ...
        if (daoSession == null) {
            daoSession = LRApplication.getDaoSession();
        }
        //清空所有数据表的缓存数据
        //daoSession.clear();
        return daoSession;
     ...
     * insert() 插入数据
     */
    public static void insertBasicBean(BasicBean bean) {
        try {
     ...
     */
    public static void insertOrReplaceBasicBean(BasicBean bean) {
        try {
     ...
     * delete()删除单个数据
     */
    public static void deleteBasicBean(BasicBean bean) {
        try {
     ...
     * deleteAll()删除所有数据
     */
    public static void deleteAllBasicBean(BasicBean bean) {
        try {
     ...
     * update()修改本地数据
     */
    public static void updateBasicBean(BasicBean bean) {
        try {
     ...
     * loadAll()查询本地所有数据
     */
    public static List<? extends BasicBean> queryAll(BasicBean bean) {
        List<BasicBean> beanList = null;
        try {
            beanList = (List<BasicBean>) getDaoInstance().loadAll(bean.getClass());
        } catch (Exception e) {
            e.printStackTrace();
     ...
     */
    public static List<? extends BasicBean> queryConditionAll(List<WhereCondition> whereConditions) throws ClassCastException {
        List<BasicBean> beanList = null;
        try {
            QueryBuilder queryBuilder = getDaoInstance().queryBuilder(BasicBean.class);
            //把条件循环加入
     ...
     */
    public static List<? extends BasicBean> querySqlAll(BasicBean bean, String sqlConditions) throws ClassCastException {
        List<BasicBean> beanList = null;
        try {
            //查询条件
            WhereCondition.StringCondition stringCondition = new WhereCondition.StringCondition(sqlConditions);
            //查询QueryBuilder
            QueryBuilder<BasicBean> queryBuilder = (QueryBuilder<BasicBean>) getDaoInstance().queryBuilder(bean.getClass());
            //添加查询条件
